...
void nmea_decode_test(void)
{
    ...
    LCD_SetColors(RED,BLACK);
  	...
  	NT35510_DispStringLine_EN(LINE(1)," Wildfire STM32-F407");
    NT35510_DispStringLine_EN(LINE(2),"  GPS module");
    ...
    while(!f_eof(&log_file))
    {
        ...
        NT35510_DispStringLine_EN(LINE(5)," GPS Info:");
...
int nmea_decode_test(void)
{
    ...
    LCD_SetColors(RED,BLACK);
  	...
  	NT35510_DispStringLine_EN_CH(LINE(1)," Wildfire STM32-F407");
    NT35510_DispStringLine_EN_CH(LINE(2),"  GPS module");
...
void NT35510_DrawGPS( uint16_t usX, uint16_t usY )
{
